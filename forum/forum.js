...
success: function(data) {
    ...
    for (var i=0; i<data.length; i++) {
        ...
        for (var r = 0; (r < data.length); r++)
                {
                    if ( data[r].comment == commentId)
                    {
                        var comments = $('<tr><td style="padding-left:80px"><b><img src="forumimg.jpg" width="30px" height="30px" />' + data[r].commenter + ' :<i> ' + data[r].date + ':</i></b></br><p style="padding-left:40px">'+ data[r].post +'</p></td></tr>');
