...
<head>
	<meta charset="utf-8">
	<title>Manage Startup Owners</title>
...
<body>
<h1 style="background-color: #FFC451;height: 70px;text-align:center;padding-top:15px;color:black;font-weight:bold" class="page-header text-center">Manage Startup Owners</h1>
