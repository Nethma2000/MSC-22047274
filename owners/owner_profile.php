...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="ownerhome.php" class="logo d-flex align-items-center">
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                if ($result->num_rows > 0) {
                  ...
                  <p class="small fst-italic"><?php echo $row['idea']; ?> -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8"><?php echo $row['mobileno']; ?></div>
                      </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="update-ownerprofile.php" method="post" enctype="multipart/form-data">
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="row mb-3">
                          <label for="Country" class="col-md-4 col-lg-3 col-form-label">Mobile No</label>
                          <div class="col-md-8 col-lg-9">
                            <input name="mobile" type="text" class="form-control" id="components"
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="expereience" type="number" class="form-control" id="expereience"
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="qualifications" type="text" class="form-control" id="qualifications"
                              value="<?php echo $row['qualifications']; ?>">
                          </div>
                        </div>
                  ...
                  < </div>
                    ...
                    <div class="tab-pane fade pt-3" id="profile-change-password">
                      <form id="changePassword" action="change_ownerpassword.php" method="post">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input id="password" autocomplete="off" name="newpassword" type="password"
                        ...
                        <div class="row mb-3">
                          <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Re-enter New
                            Password</label>
                          <div class="col-md-8 col-lg-9">
                            <input id="cpassword" autocomplete="off" name="cpassword" type="password"
