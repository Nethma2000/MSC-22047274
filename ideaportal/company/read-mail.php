...
$sql = "SELECT * FROM mailbox WHERE id_mailbox='$_GET[id_mail]' AND (id_fromuser='$loggedin_advisor_id' OR id_touser='$loggedin_advisor_id')";
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                    <div class="mailbox-read-info">
                      ...
                      <h5>From: <?php echo $rowCompany['advisor_name']; ?>
