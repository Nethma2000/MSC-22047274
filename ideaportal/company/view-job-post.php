          ...
          <div class="col-md-3">
            <div class="box box-solid">
              ...
              <ul class="nav nav-pills nav-stacked">
                  <li><a href="index.php"><i style="color:#8910ad ;" class="fa fa-dashboard"></i> Dashboard</a></li>
                  <li><a href="edit-company.php"><i style="color:#8910ad ;" class="fa fa-university"></i>Company Profile</a></li>
                  <li><a href="create-job-post.php"><i style="color:#8910ad ;" class="fa fa-plus-square"></i> Add Job Vacancy</a></li>
                  <li class="active"><a href="my-job-post.php"><i style="color:#8910ad ;" class="fa fa-briefcase"></i> Added Job Vacancies</a></li>
            ...
            <div class="row margin-top-20">
              ...
              <?php
               $sql = "SELECT * FROM job_post WHERE id_company='$_SESSION[id_company]' AND id_jobpost='$_GET[id]'";
                ...
                <hr>
                <div>
                  <p><span class="margin-right-10"><i style="color: purple;" class="fa fa-life-ring"></i> <?php echo $row['experience']; ?> Years Experience</span> <i style="color: purple;" class="fa fa-calendar"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></p>              
                </div>
                <div>
