      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="box box-solid">
              ...
              <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="edit-company.php"><i style="color:#8910ad ;" class="fa fa-university"></i>Company Profile</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2 style="color: purple;"><i><b>Company Profile</b></i></h2>
            <p>You can change your company details from here...</p>
            <div class="row">
