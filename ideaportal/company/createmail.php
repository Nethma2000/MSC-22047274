...
?>
    ...
    <div class="content-wrapper" style="margin-left: 0px; margin-top: 100px;background-color: #f6f9ff;">
      ...
      <section id="candidates" class="content-header" style="margin-left: 350px;">
              ...
              <div class="box-body">
                <div class="form-group">
                  <select name="to" class="form-control">
                    <?php
                    $sql = "SELECT * FROM validationrequets INNER JOIN entrepreneurs ON validationrequets.id_user=entrepreneurs.id_user WHERE validationrequets.id_advisor='$loggedin_advisor_id' AND validationrequets.status='3'";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
