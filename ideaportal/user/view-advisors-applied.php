...
<body style="background-color: #ECF0F5;" class="hold-transition skin- sidebar-mini">
    ...
    <div class="content-wrapper" style="margin-left: 0px;">
      ...
      // $sql = "SELECT * FROM advisor_overview INNER JOIN advisor ON advisor_overview.id_advisor=advisor.id_advisor WHERE id_jobpost='$_GET[id]'";
...
<!-- Need to talk? <br><button class="btn btn-primary btn-flat">Join a meeting</button> -->
                      ...
                      <script>
                        function myFunction() {
                          alert("If you can't see the Apply button,it means you are not logged in!Please login to you job profile to apply for jobs");
                        }
                      </script>
